...
<div class="content row-Flex">
    ...
    <div id="Locked-boxes" class="lesson-boxes card">
        ...
        <div class="box">
            <p class="active" onclick="ShowVideo('Courses/PYTHON/sample2.mp4','PythonV1')">Lesson 1</p>
        </div>

        <div class="box">
            <p onclick="ShowVideo('Courses/PYTHON/sample1.mp4','PythonV2')">Lesson 2</p>
            <%
                //If user saw before video unlocks next
                if(check.AlreadySaw(RollNo, "PythonV1") == false)
                {
        ...
        <div class="box">
            <p onclick="ShowVideo('Courses/PYTHON/sample3.mp4','PythonV3')">Lesson 3</p>
            <%
                //If user saw before video unlocks next
                if(check.AlreadySaw(RollNo, "PythonV2") == false)
                {
        ...
        <div class="box pb-2">
            ...
            <%
                //If user saw before video unlocks next
                if(check.AlreadySaw(RollNo, "PythonV3") == false)
                {
