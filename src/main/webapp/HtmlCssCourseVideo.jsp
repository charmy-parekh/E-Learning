...
<div class="content row-Flex">
    ...
    <div id="Locked-boxes" class="lesson-boxes card">
        ...
        <div class="box">
            <p class="active" onclick="ShowVideo('Courses/HTML/sample2.mp4','HtmlV1')">Lesson 1</p>
        </div>

        <div class="box">
            <p onclick="ShowVideo('Courses/HTML/sample1.mp4','HtmlV2')">Lesson 2</p>
            <%
                //If user saw before video unlocks next
                if(check.AlreadySaw(RollNo, "HtmlV1") == false)
                {
        ...
        <div class="box">
            <p onclick="ShowVideo('Courses/HTML/sample3.mp4','HtmlV3')">Lesson 3</p>
            <%
                //If user saw before video unlocks next
                if(check.AlreadySaw(RollNo, "HtmlV2") == false)
                {
