...
<meta charset="utf-8">
  ...
  <body>
    ...
    <header class="navbar navbar-light sticky-top bg-light flex-md-nowrap p-3 shadow">
        ...
        <img src = "${pageContext.request.contextPath}/images/elearninglogo.png" alt = "logo" width = "20%"/>
        
        <div class="navbar-nav">
          <div class="nav-item text-nowrap">
            <form action = "AdminLogout" method="post">
              <button type="submit" class="btn nav-link"><i class="fas fa-sign-out-alt fa-2x"></i>LogOut</button>
            </form>
          </div>
        </div>
      </header>
        ...
        <div class="row">
          <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse bg-dark" style="height: 95vh;">
           ...
           <div class="container col-md-9 d-flex align-items-center justify-content-center">
            <img src="${pageContext.request.contextPath}/images/Admin.png" alt="" class="img-fluid">
          </div>
